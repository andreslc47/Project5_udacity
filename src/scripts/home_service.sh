...
sleep 5
xterm -e " source /opt/ros/kinetic/setup.bash ; source $(echo $HOME)/Project5_udacity/devel/setup.bash ; rosrun pick_objects pick_objects " &
xterm -e " source /opt/ros/kinetic/setup.bash ; source $(echo $HOME)/Project5_udacity/devel/setup.bash ; rosrun add_markers add_markers "
