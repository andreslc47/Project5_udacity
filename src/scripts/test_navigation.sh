...
#xterm -e " source /opt/ros/kinetic/setup.bash ; source /home/robond/Project5_udacity/devel/setup.bash ; roslaunch turtlebot_rviz_launchers view_navigation.launch " &
#sleep 5
#xterm -e " source /opt/ros/kinetic/setup.bash ; source /home/robond/Project5_udacity/devel/setup.bash ; rosrun map_server map_server /home/robond/Project5_udacity/src/map/map.yaml "
