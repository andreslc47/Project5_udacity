...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot_interactive_markers_SOURCE_PREFIX /home/robond/Project5_udacity/src/turtlebot_interactions/turtlebot_interactive_markers)
  set(turtlebot_interactive_markers_DEVEL_PREFIX /home/robond/Project5_udacity/devel)
  ...
  set(turtlebot_interactive_markers_INSTALL_PREFIX /home/robond/Project5_udacity/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/Project5_udacity/install/${idir}'.  Ask the maintainer 'Daniel Stonier <stonier@yujinrobot.com>' to fix it.")
    endif()
